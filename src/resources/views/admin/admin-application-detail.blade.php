    ...
    <form class="form" action="{{ url('/stamp_correction_request/approve/' . $application->id) }}" method="post">
        ...
        <div class="form__content">
            ...
            <div class="form__group">
                ...
                <input class="form__input" type="text" value="{{ \Carbon\Carbon::parse($application->new_date)->format('Y年') }}" readonly>
                <input class="form__input" type="text" value="{{ \Carbon\Carbon::parse($application->new_date)->format('m月d日') }}" readonly>
            </div>
            ...
            <div class="form__group">
                ...
                <textarea class="form__textarea" name="comment" readonly>{{ $application->comment }}</textarea>
            </div>
        </div>
