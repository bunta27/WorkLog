    ...
    <form class="attendance__form" action="/attendance" method="post">
        ...
        <div class="attendance__button">
            @if($user->attendance_status === '勤務外')
                <button class="attendance__button--submit" type="submit" name="action" value="clock_in">出勤</button>
            @elseif($user->attendance_status === '出勤中')
                <button class="attendance__button--submit" type="submit" name="action" value="clock_out">退勤</button>
                <button class="attendance-break__button--submit" type="submit" name="action" value="break_in">休憩入</button>
            @elseif($user->attendance_status === '休憩中')
                <button class="attendance-break__button--submit" type="submit" name="action" value="break_out">休憩戻</button>
